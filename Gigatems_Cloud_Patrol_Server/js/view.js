...
//Server Url
var serverUrl = "http://140.133.74.49:8080/";
//預設畫面
	...
	try
	{
		...
		function loginEnter_Function()
		{
			...
			else
			{
				...
				var url = serverUrl + "Login_Gigatems.ashx";
				//loading
...
function createMainpage(UserName,Power)
{
	try
	{
		...
		new function()
		{
			...
			//標題
			$('#Mainpage_Header').append('<div style="line-height: 75px;">Gigatems Cloud Patrol Server V1.1(多國語言完成)</div>');
			//右下角
