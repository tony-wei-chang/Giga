		...
		$("#Mainpage_Header_Function_2").click(function()
		{
			...
			new function()
			{
				...
				$("#HomeTab_a a").click(function()
				{
					...
					check_TableName();
					ajaxData_withType(Home_Y02_a,"Select","{}",null);
				});
				//建立客戶設備啟用管理表格
				...
				//改寫撈資料參數
				var object = "";
				Home_Y02_a.setLoad_Formdata(object);
				...
				function fkSetting()
				{
					...
					$("#Home_Y02_a_Table_Inner_-1_g_name_valueField").bind("DOMSubtreeModified", function()
					{
						...
						check_TableName();
			    		//執行查詢
			    		ajaxData_withType(view,"Select","{}",null);
					});
			...
			new function()
			{
				...
				$("#HomeTab_b a").click(function()
				{
					...
					check_TableName();
					ajaxData_withType(Home_Y02_b,"Select","{}",null);
				});
				//建立客戶設備啟用管理表格
				...
				//改寫撈資料參數
				var object = "";
				Home_Y02_b.setLoad_Formdata(object);
				//Home_Y02_b.load();
				//CSS
			...
			new function()
			{
				...
				$("#HomeTab_c a").click(function()
				{
					...
					check_TableName();
					ajaxData_withType(Home_Y02_c,"Select","{}",null);
				});
				//建立客戶設備啟用管理表格
				...
				//改寫撈資料參數
				var object = "";
				Home_Y02_c.setLoad_Formdata(object);
				//Home_Y02_c.load();
				//CSS
			...
			{
				$("#Mainpage_Header_Function_2").click();
			});
			//檢查資料表名稱
			check_TableName();
